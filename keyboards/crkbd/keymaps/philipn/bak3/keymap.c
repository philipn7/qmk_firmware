...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_miryoku(
    LGUI_T(KC_Q),      LALT_T(KC_W),      KC_F,              KC_P,              KC_B,              KC_J,              KC_L,              KC_U,              LALT_T(KC_Y),      LGUI_T(KC_QUOT),
    KC_A,              KC_R,              LSFT_T(KC_S),      LCTL_T(KC_T),      KC_G,              KC_M,              LCTL_T(KC_N),      LSFT_T(KC_E),      KC_I,              KC_O,
    KC_Z,              ALGR_T(KC_X),      KC_C,              KC_D,              KC_V,              KC_K,              KC_H,              KC_COMM,           KC_DOT,            KC_SLSH,
    U_NP,              U_NP,              LT(NAV, KC_ESC),   LT(NUM, KC_SPC),   LT(MOUSE, KC_TAB), LT(FUN, KC_ENT),   LT(SYM, KC_BSPC),  LT(MOUSE, KC_DEL),   U_NP,              U_NP
  ),
  [NAV] = LAYOUT_miryoku(
    RESET,   U_NA,    U_NA,    U_NA,    U_NA,    KC_INS,  KC_HOME, KC_UP,   KC_END,  KC_PGUP,
    KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, U_NA,    KC_CAPS, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,
  ...
  [MBO] = LAYOUT_miryoku(
    ...
    KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_TRNS, KC_TRNS, KC_LCTL, KC_LSFT, KC_LALT, KC_LGUI,
  ...
  [NUM] = LAYOUT_miryoku(
   KC_LCBR, KC_LPRN, KC_RPRN,  KC_RCBR, KC_COMM,                     KC_MINS, KC_7,    KC_8,    KC_9,    KC_BSPC,
   KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT,KC_SPC,                        KC_PLUS,  KC_4,    KC_5,    KC_6,    KC_ASTERISK,
   KC_LBRC, KC_LT,    KC_GT,   KC_RBRC, KC_DOT,                    KC_BSLS, KC_1,    KC_2,    KC_3,    KC_SLSH,
   U_NP,    U_NP,    KC_LPRN, U_NA, KC_UNDS,                         KC_BSPC, KC_0,    KC_UNDS,  U_NP,    U_NP
  ),
  [SYM] = LAYOUT_miryoku(
    KC_LCBR, KC_EXLM, KC_AT,  KC_RCBR, KC_PIPE,           U_NA,    U_NA,    KC_BSLS,    U_NA,    KC_COLN,
    KC_LPRN, KC_HASH, KC_DLR,   KC_RPRN, KC_GRV,          KC_PLUS,    KC_MINS,      KC_SLSH,      KC_ASTR,      KC_SCLN,
    KC_LBRC, KC_PERC, KC_CIRC,   KC_RBRC, KC_TILD,        KC_AMPR,    KC_EQL,    KC_LT,    KC_GT,    KC_QUES,
    U_NP,    U_NP,    KC_LPRN, KC_SPC, KC_UNDS,           KC_ENT,  U_NA, KC_DEL,  U_NP,    U_NP
  ), 
  [FUN] = LAYOUT_miryoku(
    ...
    U_NP,    U_NP,    U_NA,    U_NA,    U_NA,    KC_TAB,  KC_SPC,  U_NA,  U_NP,    U_NP
  )
...
,
  ...
  [MOUSE] = LAYOUT_miryoku(
    RESET,   U_NA,    U_NA,    U_NA,    U_NA,    U_NA,    U_NA,    KC_MS_U, U_NA,    U_NA,
    KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, U_NA,    U_NA,    KC_MS_L, KC_MS_D, KC_MS_R, U_NU,
