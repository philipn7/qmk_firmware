...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_miryoku(
    TD(TD_Q_NAV),      ALGR_T(KC_W),      KC_F,              KC_P,              KC_B,                  KC_J,              KC_L,              KC_U,                KC_Y,              KC_QUOT,
    LT(NAV, KC_A),     KC_R,              KC_S,              LSFT_T(KC_T),      G_SCRL,                KC_M,              LSFT_T(KC_N),      KC_E,                KC_I,              LT(NUM, KC_O),
    KC_Z,              LALT_T(KC_X),      LSFT_T(KC_C),      LCTL_T(KC_D),      LGUI_T(KC_V),          LGUI_T(KC_K),      LCTL_T(KC_H),      LSFT_T(KC_COMM),     LALT_T(KC_DOT),    KC_SLSH,
    U_NP,              U_NP,              KC_SPC,            LSFT_T(KC_TAB),    KC_ESC,                LT(FUN,KC_DEL),    LT(NUM, KC_ENT),   LT(SYM, KC_BSPC),       U_NP,              U_NP
  ),
  [NAV] = LAYOUT_miryoku(
    TO(0),   KC_ALGR, U_NA,    U_NA,    KC_NLCK,    KC_INS,  KC_HOME, KC_UP,   KC_END,  KC_PGUP,
    U_NA,    U_CUT,   U_CPY,   U_PST,   G_SCRL,       KC_CAPS, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,
    RESET,   KC_LALT, KC_LSFT, KC_LCTL, KC_LGUI,    U_RDO,   U_PST,   U_CPY,   U_CUT,   U_UND,  
  ...
  [NUM] = LAYOUT_miryoku(
   ...
   U_NA,    KC_LALT, KC_LSFT, KC_LCTL, KC_LGUI,                    KC_MINS,  KC_1,    KC_2,    KC_3,    KC_ASTR,
  ...
  [FUN] = LAYOUT_miryoku(
    ...
    U_NA,    KC_LALT, KC_LSFT, KC_LCTL, KC_LGUI, KC_PAUS, KC_F1,   KC_F2,   KC_F3,   KC_F10,
